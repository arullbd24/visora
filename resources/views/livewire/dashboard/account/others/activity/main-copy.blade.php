<div>
    <div class="headerProfileActivity">
        <div class="txHeader text-xl font-semibold">
            <h2>Profile Activity</h2>
        </div>
    </div>
    
    <div class="ctr-lstProfileActivity">
        @livewire('Dashboard.Account.Others.Activity.Data.Main', ['lazy' => true])
        <div class="cLstProfileActivity">
            <div class="itm-profileActivity bg-white p-2 shadow-md shadow-gray-200 rounded-lg" data-log-id="">
                <div class="cItmProfileActivity">
                    <div class="mainDataProfileActivity">
                        <div class="icnLblActivity">
                            <ag-icon class="size-8 flex items-center justify-center">
                                <i class="fas fa-check"></i>
                            </ag-icon>
                        </div>
                        <div class="dataItmProfileActivity">
                            <div class="txTitlteActivity">
                                <p>Text title</p>
                            </div>
                        </div>
                    </div>
                    <div class="detailDataProfileActivity">
    ...
    <div class="ctr activity-history-container max-w-4xl mx-auto p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
                ...
                <li class="activity-item border-b border-gray-200 pb-4">
                    <div class="w-full flex justify-between items-center text-left">
                        <div class="activity-detail flex items-center space-x-4">
                            <div class="activity-icon bg-gray-200 size-7 rounded-full flex items-center justify-center text-black">
