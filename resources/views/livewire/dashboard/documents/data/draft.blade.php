                    ...
                    <div class="cListMainDocumentData">
                        @foreach ($list_document_paginate as $idx => $itm_document)
                            @php
                                ...
                                $docsAction = (object) array(
                                    'id_file_disk' => $itm_document->id_file_disk,
                                    '_token' => csrf_token()
                                );
                            @endphp
                            <div class="itm-documentData py-2 px-4 bg-gray-100 hover:bg-gray-200 relative group {{ $idx == $list_document_paginate->count()-1 ? 'rounded-b-lg' : '' }}" data-document-action="{{ encrypt($docsAction) }}">
