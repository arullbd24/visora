<div x-data="signaturePadComponent()">
    {{-- <p>{{ $draw_data }}</p> --}}
    {{-- <div class="ctr-headerSignature">
        <div class="cHeaderSignature flex transition-transform duration-500 ease-in-out" :class="{'mr-64': open}">
            <div class="mainHeaderSignature">
                <div class="txHeader w-full flex justify-between items-center">
                    <h1 class="text-2xl font-semibold text-gray-900">Initial design</h1>
        ...
        <div class="cHeaderInitial flex relative transition-transform duration-500 ease-in-out" :class="{'mr-64': open}">
            <div class="container mx-auto p-6 overflow-auto">
                ...
                <div class="titleHeaderInitial w-full">
                    ...
                    <div class="descHeaderSignature">
                        <div class="txDescHeader text-gray-600 text-sm">
                            <p>Choose the initial design that will be used in your document</p>
                        </div>
                    </div>
                    ...
                    {{-- <div class="flex items-center mt-6">
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-gray-700">Show initial detail</span>
                        </label>
                    </div> --}}
                ...
                <div x-show="isDrawOpen" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div class="bg-white w-full max-w-lg p-6 rounded-lg">
                        ...
                        <div class="border p-4">
                            <p class="text-sm text-gray-500">Draw initial here</p>
                ...
                <div x-show="isUploadOpen" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div class="bg-white w-full max-w-lg p-6 rounded-lg">
                        ...
                        <div class="border p-4">
                            <p class="text-sm text-gray-500">Upload initial</p>
                            <input type="file" wire:model="file_initials" accept="image/png, image/jpeg" class="w-full text-sm" />
                        </div>
                        <div class="flex justify-end mt-4">
                            ...
                            <button wire:click="storeFileUpload" @click="isUploadOpen = false" class="bg-red-400 hover:bg-red-500 text-white px-4 py-2 rounded-lg">Save</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="ctr-mainInitial mt-12 transition-transform duration-500 ease-in-out" :class="{'mr-64': open}">
        @livewire('Dashboard.Settings.initials.data.initials', ['lazy' => true])
    </div>
</div>
...
@push('script-body-field')
    <script>
        function signaturePadComponent() {
            ...
            //         window.addEventListener('close-upload-popup', () => {
            ...
            // });
                ...
                clearSignature() {
                    ...
                    this.fileInitial = null;
                    @this.set('file_initials', null); // Reset binding Livewire
                    console.log("File initial reset:", this.fileInitial);
                },
