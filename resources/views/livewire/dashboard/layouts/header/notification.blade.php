<div class="relative" x-data="{ openNotificationHeader: false }" @mousedown.outside="openNotificationHeader = false">
    <!-- Notification Button -->
    <button type="button" wire:click="loadNotificationsHeader" @click="openNotificationHeader = !openNotificationHeader"
    ...
    <div class="absolute right-0 mt-2 w-96 z-50 transition-all duration-300 origin-top-right"
        x-show="openNotificationHeader" x-transition:enter="transition ease-out duration-200"
        x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
        x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 scale-100"
        x-transition:leave-end="opacity-0 scale-95" @click.away="openNotificationHeader = false" style="display: none;">
